...
## Post-H3 temporal ghost update (2026-06-18)
...
nested subcycling, or scheduler ownership of the AMR timeline. Long scientific convergence and real
cross-code comparison remain unexecuted future validation work.
