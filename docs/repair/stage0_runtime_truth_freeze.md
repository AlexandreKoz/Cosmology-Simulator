...
- Aligned docs, release manifest, and gate checks with the current runtime schemas: snapshot `gadget_arepo_v4`, restart `cosmosim_restart_v12`, and provenance `provenance_v5`.
